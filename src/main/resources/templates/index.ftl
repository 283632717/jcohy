...
<body id="home" class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#photos">图片</a></li> 
						<li class="scroll"><a href="#videos">视频</a></li>
                        <li class="scroll"><a href="http://123.207.137.98:8989/soft">资源</a></li>   
                        <li class="scroll"><a href="#contact">联系我</a></li>                        
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<!-- About text start -->
							<div class="section-title">
								...
								<p>越是错综复杂的问题，就越要根据简单的原理和朴素的思想进行判断和行动。我想这是拨开云雾见南山，直接洞悉事物本质和解决问题的最佳方法。</br>
						——稻盛和夫 《活法》</p>
							</div>
						<!-- About text end -->	
						</div>	
						<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
									<div class="welcome_part wow fadeInLeft">
										<div class="welcome_icon">
											<i class="fa iconfont icon-java"></i>
										</div>
										<h2>技术交流</h2>
										<p></p>
									</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
								<div class="welcome_part wow fadeInUp">
									<div class="welcome_icon">
										<i class="fa iconfont icon-ziyuan"></i>
									</div>
									<h2>资源分享</h2>
									<p></p>
								</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
								<div class="welcome_part wow fadeInDown">
									<div class="welcome_icon">
										<i class="fa iconfont icon-tupian"></i>
									</div>
									<h2>在线图片</h2>
									<p></p>
								</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
								<div class="welcome_part wow fadeInRight">
									<div class="welcome_icon">
										<i class="fa iconfont icon-video"></i>
									</div>
									<h2>在线视频</h2>
									<p></p>
								</div>
  ...
  <!-- About Section End -->		 
        ...
        <div class="container">
            ...
            <div class="text-center">
                <ul class="portfolio-filter">
                    <li><a class="active" href="#" data-filter="*">All photos</a></li>
                    <li><a href="#" data-filter=".creative">photos</a></li>
                    <li><a href="#" data-filter=".corporate">photos</a></li>
                    <li><a href="#" data-filter=".portfolio">photos</a></li>
                </ul><!--/#portfolio-filter-->
            </div>
                    ...
                    <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <p><img class="img-circle img-thumbnail" src="images/testimonial/logo.PNG" alt=""></p>
                                <h4>JCohy</h4>
                                <small>Java Software Engineer</small>
				<h4><a href="https://github.com/jiachao23/StudyNote">博客地址</a></h4>
                                <p></p>
                            </div>
                            <div class="item">
                                <p><img class="img-circle img-thumbnail" src="images/testimonial/logo.PNG" alt=""></p>
	...
	<section id="photos">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title text-center wow fadeInDown">Videos</h2>
                <p class="text-center wow fadeInDown"> </p>
            </div>

            <div class="text-center">
                <ul class="portfolio-filter">
                    <li><a class="active" href="#" data-filter="*">All Videos</a></li>
                    <li><a href="#" data-filter=".creative">Videos</a></li>
                    <li><a href="#" data-filter=".corporate">Videos</a></li>
                    <li><a href="#" data-filter=".portfolio">Videos</a></li>
                </ul><!--/#portfolio-filter-->
            </div>
					...
					<div class="col-md-6">
						<div class="contact_text">
								...
								<ul class="contact_social">
									...
									<a href="https://github.com/jiachao23"><li><i class="tw fa fa-github-square"></i></li></a>
									
								</ul>   
								<p>Copyright © 2017 Jcohy <a href="http://www.miitbeian.gov.cn" target="_blank" title="">京ICP备17050179号-1</a>&nbsp;&nbsp;<a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11011202000860"><img src="images/gongan.png"/>京公网安备 11011202000860号</a></p>
						</div>
					</div>
				</div>
			</div>
